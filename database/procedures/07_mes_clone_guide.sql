...
ALTER PROCEDURE mes.clone_guide(uuid, uuid, text, uuid, text) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.clone_guide(uuid, uuid, text, uuid, text) TO spacelinxuser;
