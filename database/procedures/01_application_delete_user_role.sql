...
ALTER PROCEDURE application.delete_user_role(uuid, uuid, text) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE application.delete_user_role(uuid, uuid, text) TO spacelinxuser;
