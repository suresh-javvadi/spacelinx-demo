...
ALTER PROCEDURE mes.reorder_guide_steps(uuid, integer) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.reorder_guide_steps(uuid, integer) TO spacelinxuser;
