...
ALTER PROCEDURE mes.consume_inventory_for_kit(uuid, integer, text, uuid) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.consume_inventory_for_kit(uuid, integer, text, uuid) TO spacelinxuser;
