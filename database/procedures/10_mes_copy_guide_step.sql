...
ALTER PROCEDURE mes.copy_guide_step(uuid, text, uuid) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.copy_guide_step(uuid, text, uuid) TO spacelinxuser;
