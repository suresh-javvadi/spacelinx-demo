...
ALTER PROCEDURE mes.create_work_package_and_work_orders(text, uuid, uuid, uuid, uuid, uuid, timestamp with time zone, timestamp with time zone, integer, text, uuid) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.create_work_package_and_work_orders(text, uuid, uuid, uuid, uuid, uuid, timestamp with time zone, timestamp with time zone, integer, text, uuid) TO spacelinxuser;
