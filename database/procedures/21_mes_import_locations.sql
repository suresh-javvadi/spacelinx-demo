...
ALTER PROCEDURE mes.import_locations(jsonb[], text, jsonb) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.import_locations(jsonb[], text, jsonb) TO spacelinxuser;
