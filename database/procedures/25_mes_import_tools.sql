...
ALTER PROCEDURE mes.import_tools(jsonb[], text, jsonb) OWNER TO spacelinxadmin;
GRANT EXECUTE ON PROCEDURE mes.import_tools(jsonb[], text, jsonb) TO spacelinxuser;
