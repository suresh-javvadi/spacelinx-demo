-- FUNCTION: mes.update_has_bom_flag()

-- DROP FUNCTION IF EXISTS mes.update_has_bom_flag();

CREATE OR REPLACE FUNCTION mes.update_has_bom_flag()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION mes.update_has_bom_flag()
