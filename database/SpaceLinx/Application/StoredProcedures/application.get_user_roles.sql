-- PROCEDURE: application.get_user_roles(character varying, character varying)

-- DROP PROCEDURE IF EXISTS application.get_user_roles(character varying, character varying);

CREATE OR REPLACE PROCEDURE application.get_user_roles(
	IN useremail text,
	IN appname text)
LANGUAGE 'plpgsql'
AS $BODY$
