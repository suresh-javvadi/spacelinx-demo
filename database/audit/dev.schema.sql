...
\restrict yLkVPMeGb6SPMGKMO7MSECCov5EVwx5A8vJOnTv25c8XhFt9YzYskUk69UAZBnA
...
CREATE TABLE common.approval_notification_recipient (
    ...
    deleted_at timestamp with time zone,
    deleted_by character varying(255),
    CONSTRAINT chk_recipient_type CHECK (((recipient_type IS NULL) OR ((recipient_type)::text = ANY ((ARRAY['CC'::character varying, 'Watcher'::character varying, 'Stakeholder'::character varying])::text[]))))
);
...
CREATE TABLE common.document (
    ...
    tags text[],
    metadata jsonb,
    CONSTRAINT chk_document_storage_type CHECK (((document_storage_type)::text = ANY ((ARRAY['uploaded'::character varying, 'external_url'::character varying])::text[])))
);
...
CREATE VIEW mes.eco_with_users_vw AS
 SELECT eco.id,
   ...
   FROM (((mes.eco eco
     LEFT JOIN application."user" req_user ON (((lower((eco.requestor)::text) = lower((req_user.email)::text)) AND (req_user.deleted_by IS NULL))))
...
CREATE TABLE pm.dashboard_widget (
    ...
    deleted_at timestamp with time zone,
    deleted_by character varying(255),
    CONSTRAINT dashboard_widget_widget_type_check CHECK (((widget_type)::text = ANY ((ARRAY['TaskSummary'::character varying, 'ProjectProgress'::character varying, 'OverdueTasks'::character varying, 'MyTasks'::character varying, 'TeamWorkload'::character varying, 'RecentActivity'::character varying, 'TimeLoggedChart'::character varying, 'MilestoneTracker'::character varying, 'PriorityBreakdown'::character varying, 'StatusDistribution'::character varying])::text[])))
);
...
CREATE TABLE pm.resource_allocation (
    ...
    CONSTRAINT resource_allocation_allocation_type_check CHECK (((allocation_type)::text = ANY ((ARRAY['Project'::character varying, 'Task'::character varying, 'Overhead'::character varying, 'Leave'::character varying, 'Training'::character varying])::text[])))
);
...
CREATE TABLE pm.task (
    ...
    CONSTRAINT chk_task_type CHECK (((task_type)::text = ANY ((ARRAY['Task'::character varying, 'Milestone'::character varying, 'SubTask'::character varying])::text[]))),
...
CREATE TABLE pm.task_assignee (
    ...
    deleted_at timestamp with time zone,
    deleted_by character varying(255),
    CONSTRAINT task_assignee_assignee_role_check CHECK (((assignee_role)::text = ANY ((ARRAY['Primary'::character varying, 'Secondary'::character varying, 'Reviewer'::character varying, 'Watcher'::character varying])::text[])))
);
...
CREATE VIEW pm.resource_workload_vw AS
 SELECT id AS user_id,
    ...
    ( SELECT count(*) AS count
           FROM pm.task t
          WHERE ((t.assigned_to_id = s.id) AND (t.deleted_at IS NULL) AND ((t.status)::text <> ALL ((ARRAY['Completed'::character varying, 'Logged'::character varying])::text[])) AND (t.due_date < CURRENT_DATE))) AS overdue_tasks_count
...
CREATE TABLE pm.task_activity (
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by character varying(255) NOT NULL,
    CONSTRAINT task_activity_activity_type_check CHECK (((activity_type)::text = ANY ((ARRAY['Created'::character varying, 'Updated'::character varying, 'Deleted'::character varying, 'Restored'::character varying, 'StatusChanged'::character varying, 'PriorityChanged'::character varying, 'AssigneeAdded'::character varying, 'AssigneeRemoved'::character varying, 'DueDateChanged'::character varying, 'StartDateChanged'::character varying, 'ProgressChanged'::character varying, 'CommentAdded'::character varying, 'CommentEdited'::character varying, 'CommentDeleted'::character varying, 'DependencyAdded'::character varying, 'DependencyRemoved'::character varying, 'SubtaskAdded'::character varying, 'SubtaskRemoved'::character varying, 'AttachmentAdded'::character varying, 'AttachmentRemoved'::character varying, 'Moved'::character varying, 'TimeLogged'::character varying])::text[])))
);
...
CREATE TABLE pm.task_dependency (
    ...
    CONSTRAINT task_dependency_dependency_type_check CHECK (((dependency_type)::text = ANY ((ARRAY['FS'::character varying, 'SS'::character varying, 'FF'::character varying, 'SF'::character varying])::text[])))
);
...
CREATE TABLE sc.goods_receipt_note (
    ...
    deleted_by character varying(255),
    vendor_id uuid,
    CONSTRAINT goods_receipt_note_status_check CHECK (((status)::text = ANY ((ARRAY['In Process'::character varying, 'Completed'::character varying, 'Partially Completed'::character varying, 'Rejected'::character varying, 'Closed'::character varying])::text[])))
);
...
CREATE TABLE sc.grn_line_item (
    ...
    CONSTRAINT grn_line_item_disposition_check CHECK (((disposition)::text = ANY ((ARRAY['Accepted'::character varying, 'Return'::character varying, 'Scrap'::character varying, 'Rework'::character varying, 'Quarantine'::character varying])::text[]))),
    CONSTRAINT grn_line_item_qc_status_check CHECK (((qc_status)::text = ANY ((ARRAY['Pending'::character varying, 'Pass'::character varying, 'Fail'::character varying, 'Accepted'::character varying])::text[]))),
    CONSTRAINT grn_line_item_tracking_method_check CHECK (((tracking_method IS NULL) OR ((tracking_method)::text = ANY ((ARRAY['None'::character varying, 'Batch'::character varying, 'Serial'::character varying])::text[]))))
);
...
CREATE TABLE sc.purchase_order (
    ...
    department_id uuid,
    CONSTRAINT chk_purchase_order_status CHECK (((status)::text = ANY ((ARRAY['Draft'::character varying, 'Submitted'::character varying, 'Issued'::character varying, 'Rejected'::character varying, 'Partially Delivered'::character varying, 'Delivered'::character varying, 'Closed'::character varying, 'Cancelled'::character varying, 'Billed'::character varying, 'Partially Billed'::character varying])::text[])))
);
...
CREATE TABLE sc.inventory_transaction (
    ...
    assigned_user_id uuid,
    department character varying(255),
    CONSTRAINT inventory_transaction_tracking_type_check CHECK (((tracking_type)::text = ANY ((ARRAY['None'::character varying, 'Batch'::character varying, 'Serial'::character varying])::text[]))),
...
CREATE TABLE sc.stock_movement_line_item (
    ...
    CONSTRAINT stock_movement_line_item_adjustment_type_check CHECK (((adjustment_type)::text = ANY ((ARRAY['Increase'::character varying, 'Decrease'::character varying])::text[]))),
...
CREATE TABLE sc.requisition (
    ...
    deleted_by character varying(255),
    department_id uuid,
    CONSTRAINT chk_requisition_status CHECK (((status)::text = ANY ((ARRAY['Draft'::character varying, 'Submitted'::character varying, 'Approved'::character varying, 'Rejected'::character varying, 'Processing'::character varying, 'PoCreated'::character varying, 'Closed'::character varying, 'Cancelled'::character varying])::text[])))
);
 ...
 SELECT r.id,
   ...
   FROM ((((sc.requisition r
     ...
     LEFT JOIN LATERAL ( SELECT purchase_order.id,
          ...
          WHERE ((purchase_order.requisition_id = r.id) AND (purchase_order.deleted_by IS NULL) AND ((purchase_order.status)::text <> ALL ((ARRAY['Cancelled'::character varying, 'Rejected'::character varying])::text[])))
...
CREATE TABLE sc.scrap_line_item (
    ...
    deleted_at timestamp with time zone,
    deleted_by character varying(255),
    CONSTRAINT scrap_line_item_tracking_type_check CHECK (((tracking_type)::text = ANY ((ARRAY['None'::character varying, 'Batch'::character varying, 'Serial'::character varying])::text[])))
);
...
CREATE TABLE sc.scrap_request (
    ...
    rejected_by character varying(255),
    rejected_date timestamp with time zone,
    CONSTRAINT scrap_request_status_check CHECK (((status)::text = ANY ((ARRAY['Draft'::character varying, 'Submitted'::character varying, 'Approved'::character varying, 'Rejected'::character varying, 'Disposed'::character varying])::text[])))
);
...
CREATE TABLE sc.vendor_return_line_item (
    ...
    deleted_at timestamp with time zone,
    deleted_by character varying(255),
    CONSTRAINT vendor_return_line_item_tracking_type_check CHECK (((tracking_type)::text = ANY ((ARRAY['None'::character varying, 'Batch'::character varying, 'Serial'::character varying])::text[])))
);
...
CREATE TABLE sc.vendor_return_request (
    ...
    rejected_by character varying(255),
    rejected_date timestamp with time zone,
    CONSTRAINT vendor_return_request_status_check CHECK (((status)::text = ANY ((ARRAY['Draft'::character varying, 'Submitted'::character varying, 'Approved'::character varying, 'Rejected'::character varying, 'Shipped'::character varying, 'Closed'::character varying])::text[])))
);
...
\unrestrict yLkVPMeGb6SPMGKMO7MSECCov5EVwx5A8vJOnTv25c8XhFt9YzYskUk69UAZBnA
