...
public partial class PurchaseOrderDetailsReadModel : BaseReadModel
{
    ...
    public virtual ICollection<PoLineItemDetailReadModel> PoLineItems { get; set; } = new List<PoLineItemDetailReadModel>();
    public List<ApprovalReadModel>? Approvals { get; set; }
}